...
| [`monitor`](./monitor) | Watches a station and prints state, scanning, connected-network, and associated-AP changes (the last is how a roam is seen) until Ctrl-C | no |
